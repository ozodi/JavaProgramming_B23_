...
public class MergeTwoArrays {
    ...
    public static void main(String[] args) {
        ...
        int[] arr1 = {1,22,33213,45,5,5,332},
              arr2 = {5,6,213,53,532,12,312};

        int[] arr3 = new int[arr1.length+ arr2.length]; // making sure that arr3 has enough capacity to contain the elements
